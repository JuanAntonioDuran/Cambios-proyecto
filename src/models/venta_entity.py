...
class VentaEntity:
    ...
    def __init__(self, id_venta, id_cancion, id_usuario, cantidad_vendida, fecha_venta):
        """
        Inicializa un objeto VentaEntity con los datos de una venta.

        Parámetros:
        - id_venta (int): ID único de la venta.
        - id_cancion (int): ID de la canción vendida.
        - id_usuario (int): ID del usuario que realizó la compra.
        - cantidad_vendida (int): Cantidad de canciones vendidas.
    ...
    def __str__(self):
        ...
        """
        return (
            f"Venta ID: {self._id_venta}, Canción ID: {self._id_cancion}, Usuario ID: {self._id_usuario}, "
    ...
    def __repr__(self):
        ...
        """
        return (
            f"VentaEntity(id_venta={self._id_venta}, id_cancion={self._id_cancion}, "
            f"id_usuario={self._id_usuario}, cantidad_vendida={self._cantidad_vendida}, "
